...
-- Volcando datos para la tabla empleamusic.agendas: ~20 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `comentarios` (
  ...
  KEY `fkaprendizcomentario` (`idaprendiz`),
  KEY `fkprofesorcomentario` (`idprofesor`),
  CONSTRAINT `fkaprendizcomentario` FOREIGN KEY (`idaprendiz`) REFERENCES `aprendizes` (`idaprendiz`),
  CONSTRAINT `fkprofesorcomentario` FOREIGN KEY (`idprofesor`) REFERENCES `profesores` (`idprofesor`)
) ENGINE=InnoDB AUTO_INCREMENT=86 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla empleamusic.comentarios: ~80 rows (aproximadamente)
INSERT INTO `comentarios` (`idcomentario`, `idprofesor`, `idaprendiz`, `descripcion`, `fechahora`, `tipo`, `created_at`, `updated_at`) VALUES
	(1, NULL, 10, 'La clase de piano fue demasiado rápida, no pude seguir el ritmo', '2023-07-13 14:00:00', 'Queja', NULL, NULL),
	(2, NULL, 12, 'Tengo un reclamo sobre la calidad del sonido en la lección de guitarra', '2023-07-14 20:30:00', 'Reclamo', NULL, NULL),
	(3, 3, NULL, 'Quisiera sugerir incluir más ejercicios de improvisación en las clases de saxofón', '2023-07-15 22:00:00', 'Sugerencia', NULL, NULL),
	(4, NULL, 14, 'No estoy satisfecho con el contenido de la clase de batería, es muy básico', '2023-07-16 15:00:00', 'Reclamo', NULL, NULL),
	(5, 3, NULL, 'Tengo un reclamo sobre la falta de atención individualizada en el entrenamiento de canto', '2023-07-17 19:00:00', 'Sugerencia', NULL, NULL),
	(6, 6, NULL, 'Quisiera sugerir más práctica de lectura de partituras en la clase de violín', '2023-07-18 21:30:00', 'Sugerencia', NULL, NULL),
	(7, 17, NULL, 'Lección de piano para todos los niveles', '2023-07-19 16:00:00', 'Sugerencia', NULL, NULL),
	(8, NULL, 18, 'La lección de flauta estuvo mal organizada, hubo demasiadas interrupciones', '2023-07-20 18:30:00', 'Queja', NULL, NULL),
	(9, NULL, 9, 'Tengo un reclamo sobre la falta de variedad de estilos musicales en la tutoría de guitarra', '2023-07-21 14:30:00', 'Sugerencia', NULL, NULL),
	(10, NULL, 11, 'Quisiera sugerir incluir ejercicios de improvisación en las clases de piano', '2023-07-22 21:00:00', 'Reclamo', NULL, NULL),
	(11, 1, NULL, 'No estoy satisfecho con la metodología de enseñanza en la clase de violonchelo', '2023-07-23 17:00:00', 'Queja', NULL, NULL),
	(12, NULL, 4, 'Lección de violín para estudiantes avanzados', '2023-07-24 20:00:00', 'Sugerencia', NULL, NULL),
	(13, NULL, 13, 'Tengo un reclamo sobre la falta de retroalimentación en la lección de canto', '2023-07-25 23:00:00', 'Sugerencia', NULL, NULL),
	(14, 14, NULL, 'La clase de trompeta estuvo desorganizada, no se siguieron los tiempos establecidos', '2023-07-26 15:30:00', 'Queja', NULL, NULL),
	(15, NULL, 15, 'Tengo un reclamo sobre la falta de material de estudio en la lección de piano', '2023-07-27 19:30:00', 'Reclamo', NULL, NULL),
	(16, 6, NULL, 'No estoy satisfecho con el enfoque de la clase de guitarra, no se abordan los estilos que me interesan', '2023-07-28 21:00:00', 'Sugerencia', NULL, NULL),
	(17, NULL, 3, 'Lección de saxofón para todos los niveles', '2023-07-29 16:30:00', 'Sugerencia', NULL, NULL),
	(18, NULL, 1, 'Tengo un reclamo sobre la falta de apoyo en la lección de saxofón', '2023-07-30 18:00:00', 'Reclamo', NULL, NULL),
	(19, NULL, 9, 'Quisiera sugerir incluir ejercicios de ritmo en las clases de batería', '2023-07-31 14:30:00', 'Sugerencia', NULL, NULL),
	(20, 20, NULL, 'Tengo un reclamo sobre la falta de seguimiento en el entrenamiento de viola', '2023-08-01 22:00:00', 'Reclamo', NULL, NULL),
	(21, NULL, 10, 'La clase de piano fue demasiado rápida, no pude seguir el ritmo', '2023-07-13 14:00:00', 'Queja', NULL, NULL),
	(22, NULL, 12, 'Tengo un reclamo sobre la calidad del sonido en la lección de guitarra', '2023-07-14 20:30:00', 'Reclamo', NULL, NULL),
	(23, 3, NULL, 'Quisiera sugerir incluir más ejercicios de improvisación en las clases de saxofón', '2023-07-15 22:00:00', 'Sugerencia', NULL, NULL),
	(24, NULL, 14, 'No estoy satisfecho con el contenido de la clase de batería, es muy básico', '2023-07-16 15:00:00', 'Reclamo', NULL, NULL),
	(25, 3, NULL, 'Tengo un reclamo sobre la falta de atención individualizada en el entrenamiento de canto', '2023-07-17 19:00:00', 'Sugerencia', NULL, NULL),
	(26, 6, NULL, 'Quisiera sugerir más práctica de lectura de partituras en la clase de violín', '2023-07-18 21:30:00', 'Sugerencia', NULL, NULL),
	(27, 17, NULL, 'Lección de piano para todos los niveles', '2023-07-19 16:00:00', 'Sugerencia', NULL, NULL),
	(28, NULL, 18, 'La lección de flauta estuvo mal organizada, hubo demasiadas interrupciones', '2023-07-20 18:30:00', 'Queja', NULL, NULL),
	(29, NULL, 9, 'Tengo un reclamo sobre la falta de variedad de estilos musicales en la tutoría de guitarra', '2023-07-21 14:30:00', 'Sugerencia', NULL, NULL),
	(30, NULL, 11, 'Quisiera sugerir incluir ejercicios de improvisación en las clases de piano', '2023-07-22 21:00:00', 'Reclamo', NULL, NULL),
	(31, 1, NULL, 'No estoy satisfecho con la metodología de enseñanza en la clase de violonchelo', '2023-07-23 17:00:00', 'Queja', NULL, NULL),
	(32, NULL, 4, 'Lección de violín para estudiantes avanzados', '2023-07-24 20:00:00', 'Sugerencia', NULL, NULL),
	(33, NULL, 13, 'Tengo un reclamo sobre la falta de retroalimentación en la lección de canto', '2023-07-25 23:00:00', 'Sugerencia', NULL, NULL),
	(34, 14, NULL, 'La clase de trompeta estuvo desorganizada, no se siguieron los tiempos establecidos', '2023-07-26 15:30:00', 'Queja', NULL, NULL),
	(35, NULL, 15, 'Tengo un reclamo sobre la falta de material de estudio en la lección de piano', '2023-07-27 19:30:00', 'Reclamo', NULL, NULL),
	(36, 6, NULL, 'No estoy satisfecho con el enfoque de la clase de guitarra, no se abordan los estilos que me interesan', '2023-07-28 21:00:00', 'Sugerencia', NULL, NULL),
	(37, NULL, 3, 'Lección de saxofón para todos los niveles', '2023-07-29 16:30:00', 'Sugerencia', NULL, NULL),
	(38, NULL, 1, 'Tengo un reclamo sobre la falta de apoyo en la lección de saxofón', '2023-07-30 18:00:00', 'Reclamo', NULL, NULL),
	(39, NULL, 9, 'Quisiera sugerir incluir ejercicios de ritmo en las clases de batería', '2023-07-31 14:30:00', 'Sugerencia', NULL, NULL),
	(40, 20, NULL, 'Tengo un reclamo sobre la falta de seguimiento en el entrenamiento de viola', '2023-08-01 22:00:00', 'Reclamo', NULL, NULL),
	(41, NULL, 10, 'La clase de piano fue demasiado rápida, no pude seguir el ritmo', '2023-07-13 14:00:00', 'Queja', NULL, NULL),
	(42, NULL, 12, 'Tengo un reclamo sobre la calidad del sonido en la lección de guitarra', '2023-07-14 20:30:00', 'Reclamo', NULL, NULL),
	(43, 3, NULL, 'Quisiera sugerir incluir más ejercicios de improvisación en las clases de saxofón', '2023-07-15 22:00:00', 'Sugerencia', NULL, NULL),
	(44, NULL, 14, 'No estoy satisfecho con el contenido de la clase de batería, es muy básico', '2023-07-16 15:00:00', 'Reclamo', NULL, NULL),
	(45, 3, NULL, 'Tengo un reclamo sobre la falta de atención individualizada en el entrenamiento de canto', '2023-07-17 19:00:00', 'Sugerencia', NULL, NULL),
	(46, 6, NULL, 'Quisiera sugerir más práctica de lectura de partituras en la clase de violín', '2023-07-18 21:30:00', 'Sugerencia', NULL, NULL),
	(47, 17, NULL, 'Lección de piano para todos los niveles', '2023-07-19 16:00:00', 'Sugerencia', NULL, NULL),
	(48, NULL, 18, 'La lección de flauta estuvo mal organizada, hubo demasiadas interrupciones', '2023-07-20 18:30:00', 'Queja', NULL, NULL),
	(49, NULL, 9, 'Tengo un reclamo sobre la falta de variedad de estilos musicales en la tutoría de guitarra', '2023-07-21 14:30:00', 'Sugerencia', NULL, NULL),
	(50, NULL, 11, 'Quisiera sugerir incluir ejercicios de improvisación en las clases de piano', '2023-07-22 21:00:00', 'Reclamo', NULL, NULL),
	(51, 1, NULL, 'No estoy satisfecho con la metodología de enseñanza en la clase de violonchelo', '2023-07-23 17:00:00', 'Queja', NULL, NULL),
	(52, NULL, 4, 'Lección de violín para estudiantes avanzados', '2023-07-24 20:00:00', 'Sugerencia', NULL, NULL),
	(53, NULL, 13, 'Tengo un reclamo sobre la falta de retroalimentación en la lección de canto', '2023-07-25 23:00:00', 'Sugerencia', NULL, NULL),
	(54, 14, NULL, 'La clase de trompeta estuvo desorganizada, no se siguieron los tiempos establecidos', '2023-07-26 15:30:00', 'Queja', NULL, NULL),
	(55, NULL, 15, 'Tengo un reclamo sobre la falta de material de estudio en la lección de piano', '2023-07-27 19:30:00', 'Reclamo', NULL, NULL),
	(56, 6, NULL, 'No estoy satisfecho con el enfoque de la clase de guitarra, no se abordan los estilos que me interesan', '2023-07-28 21:00:00', 'Sugerencia', NULL, NULL),
	(57, NULL, 3, 'Lección de saxofón para todos los niveles', '2023-07-29 16:30:00', 'Sugerencia', NULL, NULL),
	(58, NULL, 1, 'Tengo un reclamo sobre la falta de apoyo en la lección de saxofón', '2023-07-30 18:00:00', 'Reclamo', NULL, NULL),
	(59, NULL, 9, 'Quisiera sugerir incluir ejercicios de ritmo en las clases de batería', '2023-07-31 14:30:00', 'Sugerencia', NULL, NULL),
	(60, 20, NULL, 'Tengo un reclamo sobre la falta de seguimiento en el entrenamiento de viola', '2023-08-01 22:00:00', 'Reclamo', NULL, NULL),
	(61, NULL, 10, 'La clase de piano fue demasiado rápida, no pude seguir el ritmo', '2023-07-13 14:00:00', 'Queja', NULL, NULL),
	(62, NULL, 12, 'Tengo un reclamo sobre la calidad del sonido en la lección de guitarra', '2023-07-14 20:30:00', 'Reclamo', NULL, NULL),
	(63, 3, NULL, 'Quisiera sugerir incluir más ejercicios de improvisación en las clases de saxofón', '2023-07-15 22:00:00', 'Sugerencia', NULL, NULL),
	(64, NULL, 14, 'No estoy satisfecho con el contenido de la clase de batería, es muy básico', '2023-07-16 15:00:00', 'Reclamo', NULL, NULL),
	(65, 3, NULL, 'Tengo un reclamo sobre la falta de atención individualizada en el entrenamiento de canto', '2023-07-17 19:00:00', 'Sugerencia', NULL, NULL),
	(66, 6, NULL, 'Quisiera sugerir más práctica de lectura de partituras en la clase de violín', '2023-07-18 21:30:00', 'Sugerencia', NULL, NULL),
	(67, 17, NULL, 'Lección de piano para todos los niveles', '2023-07-19 16:00:00', 'Sugerencia', NULL, NULL),
	(68, NULL, 18, 'La lección de flauta estuvo mal organizada, hubo demasiadas interrupciones', '2023-07-20 18:30:00', 'Queja', NULL, NULL),
	(69, NULL, 9, 'Tengo un reclamo sobre la falta de variedad de estilos musicales en la tutoría de guitarra', '2023-07-21 14:30:00', 'Sugerencia', NULL, NULL),
	(70, NULL, 11, 'Quisiera sugerir incluir ejercicios de improvisación en las clases de piano', '2023-07-22 21:00:00', 'Reclamo', NULL, NULL),
	(71, 1, NULL, 'No estoy satisfecho con la metodología de enseñanza en la clase de violonchelo', '2023-07-23 17:00:00', 'Queja', NULL, NULL),
	(72, NULL, 4, 'Lección de violín para estudiantes avanzados', '2023-07-24 20:00:00', 'Sugerencia', NULL, NULL),
	(73, NULL, 13, 'Tengo un reclamo sobre la falta de retroalimentación en la lección de canto', '2023-07-25 23:00:00', 'Sugerencia', NULL, NULL),
	(74, 14, NULL, 'La clase de trompeta estuvo desorganizada, no se siguieron los tiempos establecidos', '2023-07-26 15:30:00', 'Queja', NULL, NULL),
	(75, NULL, 15, 'Tengo un reclamo sobre la falta de material de estudio en la lección de piano', '2023-07-27 19:30:00', 'Reclamo', NULL, NULL),
	(76, 6, NULL, 'No estoy satisfecho con el enfoque de la clase de guitarra, no se abordan los estilos que me interesan', '2023-07-28 21:00:00', 'Sugerencia', NULL, NULL),
	(77, NULL, 3, 'Lección de saxofón para todos los niveles', '2023-07-29 16:30:00', 'Sugerencia', NULL, NULL),
	(78, NULL, 1, 'Tengo un reclamo sobre la falta de apoyo en la lección de saxofón', '2023-07-30 18:00:00', 'Reclamo', NULL, NULL),
	(79, NULL, 9, 'Quisiera sugerir incluir ejercicios de ritmo en las clases de batería', '2023-07-31 14:30:00', 'Sugerencia', NULL, NULL),
	(80, 20, NULL, 'Tengo un reclamo sobre la falta de seguimiento en el entrenamiento de viola', '2023-08-01 22:00:00', 'Reclamo', NULL, NULL),
	(81, NULL, NULL, 'no me gusta su diseño', '2023-08-31 03:37:02', 'Reclamo', '2023-08-31 03:37:02', '2023-08-31 03:37:02'),
	(82, NULL, NULL, 'Hola', '2023-08-31 08:08:47', 'Sugerencia', '2023-08-31 08:08:47', '2023-08-31 08:08:47'),
	(83, NULL, NULL, 'Hola', '2023-08-31 08:09:06', 'Sugerencia', '2023-08-31 08:09:06', '2023-08-31 08:09:06'),
	(84, NULL, NULL, 'Hola', '2023-08-31 08:09:54', 'Reclamo', '2023-08-31 08:09:54', '2023-08-31 08:09:54'),
	(85, 2, NULL, 'asdasd', '2023-08-31 08:12:40', 'asdsa', '2023-08-31 08:12:40', '2023-08-31 08:12:40');
...
-- Volcando estructura para tabla empleamusic.solicitudagendas
CREATE TABLE IF NOT EXISTS `solicitudagendas` (
  `idsolicitudagenda` int NOT NULL AUTO_INCREMENT,
  `idclase` int NOT NULL,
  `idaprendiz` int DEFAULT NULL,
  `documento` varchar(500) NOT NULL DEFAULT '0',
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`idsolicitudagenda`),
  KEY `fk_solicitudagenda_clase` (`idclase`),
  KEY `fk_solicitudagenda_aprendiz` (`idaprendiz`),
  CONSTRAINT `fk_solicitudagenda_aprendiz` FOREIGN KEY (`idaprendiz`) REFERENCES `aprendizes` (`idaprendiz`),
  CONSTRAINT `fk_solicitudagenda_clase` FOREIGN KEY (`idclase`) REFERENCES `clases` (`idclase`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla empleamusic.solicitudagendas: ~6 rows (aproximadamente)
INSERT INTO `solicitudagendas` (`idsolicitudagenda`, `idclase`, `idaprendiz`, `documento`, `fechaagendada`, `fechahora`, `descripcion`, `created_at`, `updated_at`) VALUES
	(8, 21, 80, '100238472', '2023-08-23 23:39:50', '2023-08-20 12:03:00', 'Hola', '2023-08-23 23:39:50', '2023-08-23 23:39:50'),
	(9, 23, 65, '1002233', '2023-08-24 03:37:21', '2023-08-20 12:32:00', 'HOlA', '2023-08-24 03:37:21', '2023-08-24 03:37:21'),
	(10, 23, 61, '1003233414', '2023-08-29 00:18:09', '2023-08-15 12:03:00', 'Hola', '2023-08-29 00:18:09', '2023-08-29 00:18:09'),
	(11, 23, 65, '10093322', '2023-08-30 22:52:26', '2023-08-31 12:03:00', 'HOlA', '2023-08-30 22:52:26', '2023-08-30 22:52:26'),
	(12, 25, 62, '10023233', '2023-08-31 04:00:08', '2024-02-12 13:30:00', 'hola', '2023-08-31 04:00:08', '2023-08-31 04:00:08'),
	(13, 3, 86, '10002344332', '2023-08-31 08:42:10', '2025-04-14 12:32:00', 'hola', '2023-08-31 08:42:11', '2023-08-31 08:42:11');
